...
export const indianCities = [
  ...
  { name: 'Nashik', state: 'Maharashtra', lat: 20.0059, lng: 73.7620 },
  { name: 'Faridabad', state: 'Haryana', lat: 28.4089, lng: 77.3178 },
  { name: 'Meerut', state: 'Uttar Pradesh', lat: 28.6139, lng: 77.2090 },
  { name: 'Rajkot', state: 'Gujarat', lat: 22.2736, lng: 70.7513 },
